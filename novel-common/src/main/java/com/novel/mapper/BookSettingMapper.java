...
public interface BookSettingMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(BookSettingDynamicSqlSupport.id, BookSettingDynamicSqlSupport.bookId, BookSettingDynamicSqlSupport.sort, BookSettingDynamicSqlSupport.type, BookSettingDynamicSqlSupport.createTime, BookSettingDynamicSqlSupport.createUserId, BookSettingDynamicSqlSupport.updateTime, BookSettingDynamicSqlSupport.updateUserId);
