...
import com.novel.entity.BookContent;
...
public interface BookContentMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(BookContentDynamicSqlSupport.id, BookContentDynamicSqlSupport.indexId, BookContentDynamicSqlSupport.content);
